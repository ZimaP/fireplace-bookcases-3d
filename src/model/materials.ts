...
export function createMaterialLibrary(
  ...
  return {
    ...
    cabinetEdge: new THREE.MeshPhysicalMaterial({
      color: shadeColor(cabinetColor, 0.91),
      map: cabinetTexture,
      roughness: 0.43,
      clearcoat: 0.2,
    ...
    cabinetShadow: new THREE.MeshStandardMaterial({
      color: shadeColor(cabinetColor, cabinetFinish === 'deep-green' ? 0.62 : 0.8),
      roughness: 0.75,
    }),
    interiorBack: new THREE.MeshStandardMaterial({
      color: shadeColor(cabinetColor, cabinetFinish === 'deep-green' ? 0.78 : 0.88),
      map: cabinetTexture,
      roughness: 0.68,
    }),
